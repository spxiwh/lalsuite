...
from lalinspiral import InspiralSBankComputeMatch, InspiralSBankComputeMatchMaxSkyLoc, InspiralSBankComputeMatchMaxSkyLocNoPhase
...
class PrecessingSpinTemplate(AlignedSpinTemplate):
    ...
    def brute_match(self, other, df, workspace_cache, **kwargs):
        ...
        return InspiralSBankComputeMatchMaxSkyLoc(hp, hc, 1., 1., hphccorr,
