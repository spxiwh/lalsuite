...
class Bank(object):
    ...
    def __init__(self, noise_model, flow, use_metric=False,
                 cache_waveforms=False, nhood_size=1.0, nhood_param="tau0",
                 coarse_match_df=None, iterative_match_df_max=None,
